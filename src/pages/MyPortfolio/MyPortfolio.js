      ...
      <div className="card w-96 bg-base-100 shadow-xl mx-auto mb-5">
        <div className="card-body">
          ...
          <div className="flex items-center gap-3 justify-center">
            ...
            <h2>mdmazharulislam.dev@gmail.com</h2>
          </div>
        </div>
      </div>
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <a
              ...
              href="https://vehicle-storehouse.web.app/"
            >
              Vehicle Store House
            </a>
            <a
              className="link link-accent"
              href="https://assignment-ten.netlify.app/"
            >
              Health is Happiness
            </a>
            <a
              className="link link-accent"
              href="https://assignment-nine.netlify.app/"
            >
              Simple Laptop Shop
            </a>
          </div>
